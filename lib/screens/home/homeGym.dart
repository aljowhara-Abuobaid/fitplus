...
class _HomePageGymState extends State<HomePageGym> {
          ...
          actions: [
            TextButton(
                onPressed: () async {
                  ...
                  // await FbFireStoreController().fitchUserData();
                  // setState(() {});
                },
                child: Text(
                  'Logout',
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                              AppController.to.loginMap['workingHours'].length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return Container(
                                  height: 40,
  ...
  Future<void> pickImageAfterSelectForImage2(
    ...
    if (widget._pickedFile != null) {
      ...
      await FbFireStoreController()
          .updateUser(context: context, data: {'logo2': url});
      setState(() {});
    }
  }
  ...
  Future<void> pickImageAfterSelectForAddImageGym(
    ...
    if (widget._pickedFile2 != null) {
      ...
      imageList.add(url);
      await FbFireStoreController()
          .updateUser(context: context, data: {'images': imageList});
      setState(() {});
    }
  }
}
